...
describe('CaptureDetailPage Component', () => {
  ...
  test('displays loading state initially', () => {
    mockCapturesApi.getCapture.mockImplementation(
  ...
  test('loads and displays capture', async () => {
    mockCapturesApi.getCapture.mockResolvedValue(mockCapture);
  ...
  test('displays error when capture is not found', async () => {
    mockCapturesApi.getCapture.mockRejectedValue(new Error('Not found'));
